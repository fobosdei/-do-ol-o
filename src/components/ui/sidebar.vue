...
const { isAboutOpen, isContactOpen, toggleContact } = useUIState()

const sidebarItems = [
  { icon: 'github', label: 'GitHub', href: 'https://github.com/fobosdei', action: null },
  { icon: 'linkedin', label: 'LinkedIn', href: 'https://www.linkedin.com/in/juan-manuel-fernandez-idrobo-11158736a', action: null },
  { icon: 'instagram', label: 'Instagram', href: 'https://www.instagram.com/juan_manuelfer?igsh=MWh1ZXpqc3FvdGgwdw==', action: null },
  { icon: 'twitter', label: 'Twitter', href: '#', action: null },
  { icon: 'mail', label: 'Email', href: '#', action: 'contact' }
]
...
<template>
  <aside class="floating-sidebar" :class="{ 'sidebar-hidden': isAboutOpen || isContactOpen }">
    <LiquidGlass
      :width="'100%'"
      :height="'auto'"
      :border-radius="50"
    ...
    >
      <div class="sidebar-content">
        <a
          ...
          @click.prevent="item.action === 'contact' ? toggleContact() : undefined"
          :title="item.label"
        >
